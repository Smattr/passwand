 ...
 * @param mainpass    The main passphrase
 ...
 *
 * @param mainpass Main passphrase
...
/** Reset the state of the allocator, releasing cached memory to the operating
 * system.
 *
 * This function should only be called when you have freed any outstanding
 * allocations from the allocator.
 *
